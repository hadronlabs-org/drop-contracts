module me::drop_lp {
    ...
    #[test(chain = @me)]
    #[expected_failure]
    fun test_execute_callback_uninitialized(chain: &signer) acquires LpConfig {
        initia_std::primary_fungible_store::init_module_for_test();
        initia_std::dex::init_module_for_test();
        ...
        callback(chain, PROVIDE_CB_ID, true); // just a random address
    }
    
    #[test(chain = @me)]
    fun test_execute_callback_success(chain: &signer) acquires LpConfig {
        initia_std::primary_fungible_store::init_module_for_test();
        initia_std::dex::init_module_for_test();
        ...
        lp_object_config.decimals = 1u64;
        lp_object_config.price = 10u256;
        ...
        callback(&lp_signer, PROVIDE_CB_ID, true);
