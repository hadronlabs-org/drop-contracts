...
export interface DropCoreSchema {
    responses: ArrayOfString | ArrayOfAddr | Config | ContractState | Uint1281 | Decimal | FailedBatchResponse | LastPuppeteerResponse | String | PauseInfoResponse | Uint1282 | Uint1283 | Uint1284 | UnbondBatch | UnbondBatchesResponse;
    query: UnbondBatchArgs | UnbondBatchesArgs;
    execute: BondArgs | AddBondProviderArgs | RemoveBondProviderArgs | UpdateConfigArgs | UpdateWithdrawnAmountArgs | PeripheralHookArgs | ProcessEmergencyBatchArgs | SetBondHooksArgs | UpdateOwnershipArgs;
