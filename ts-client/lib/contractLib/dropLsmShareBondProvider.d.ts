...
export interface DropLsmShareBondProviderSchema {
    responses: Uint128 | Boolean | Boolean1 | Config | ArrayOfTupleOfStringAndTupleOfStringAndUint128 | OwnershipForString | ArrayOfTupleOfStringAndTupleOfStringAndUint1281 | Decimal;
