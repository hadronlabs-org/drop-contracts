...
export class Client {
  ...
  stakerHookMsg = (args: StakerHookArgs): { staker_hook: StakerHookArgs } => { return { staker_hook: args }; }
  ...
  resetBondedAmountMsg = (): { reset_bonded_amount: {} } => { return { reset_bonded_amount: {} } }
