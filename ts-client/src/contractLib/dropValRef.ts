...
export class Client {
  ...
  queryRef = async(args: RefArgs): Promise<Ref> => {
    return this.client.queryContractSmart(this.contractAddress, { ref: args });
  }
  queryAllRefs = async(): Promise<ArrayOfRef> => {
    return this.client.queryContractSmart(this.contractAddress, { all_refs: {} });
  }
  queryOwnership = async(): Promise<OwnershipForString> => {
    return this.client.queryContractSmart(this.contractAddress, { ownership: {} });
  }
  bondCallback = async(sender:string, args: BondCallbackArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
    return this.client.execute(sender, this.contractAddress, this.bondCallbackMsg(args), fee || "auto", memo, funds);
  }
  bondCallbackMsg = (args: BondCallbackArgs): { bond_callback: BondCallbackArgs } => { return { bond_callback: args }; }
  ...
  setRefs = async(sender:string, args: SetRefsArgs, fee?: number | StdFee | "auto", memo?: string, funds?: Coin[]): Promise<ExecuteResult> =>  {
          if (!isSigningCosmWasmClient(this.client)) { throw this.mustBeSigningClient(); }
    return this.client.execute(sender, this.contractAddress, this.setRefsMsg(args), fee || "auto", memo, funds);
  }
  setRefsMsg = (args: SetRefsArgs): { set_refs: SetRefsArgs } => { return { set_refs: args }; }
