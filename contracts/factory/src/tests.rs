...
fn test_query_pause_info() {
    ...
    let api = deps.api;
    deps.querier
        .add_wasm_query_response(api.addr_make("core_contract").as_str(), |_| -> cosmwasm_std::Binary {
    ...
    deps.querier
        .add_wasm_query_response(api.addr_make("rewards_manager_contract").as_str(), |_| -> cosmwasm_std::Binary {
