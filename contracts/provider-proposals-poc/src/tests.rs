        ...
        vec![
            Event::new("crates.io:drop-staking__drop-provider-proposals-poc-instantiate")
                .add_attributes([
                    ...
                    attr("validators_set_address", api.addr_make("validators_set")),
...
fn update_config_wrong_owner() {
    ...
    drop_staking_base::state::provider_proposals::CONFIG
        .save(
            ...
            &drop_staking_base::state::provider_proposals::Config {
                ...
                update_period: 100,
                core_address: api.addr_make("core").to_string(),
                proposal_votes_address: Some(api.addr_make("proposal_votes").to_string()),
                validators_set_address: api.addr_make("validators_set").to_string(),
                init_proposal: 1,
                proposals_prefetch: 5,
                veto_spam_threshold: Decimal::from_atomics(1u64, 2).unwrap(),
    ...
    let error = crate::contract::execute(
        ...
        drop_staking_base::msg::provider_proposals::ExecuteMsg::UpdateConfig {
            new_config: drop_staking_base::state::provider_proposals::ConfigOptional {
                ...
                proposal_votes_address: Some(api.addr_make("proposal_votes").to_string()),
                validators_set_address: Some(api.addr_make("validators_set").to_string()),
                init_proposal: None,
    ...
    assert_eq!(
        ...
        crate::error::ContractError::OwnershipError(cw_ownable::OwnershipError::Std(
            cosmwasm_std::StdError::not_found("type: cw_ownable::Ownership<cosmwasm_std::addresses::Addr>; key: [6F, 77, 6E, 65, 72, 73, 68, 69, 70]".to_string())
        ))
    );
}
...
fn update_config_ok() {
    ...
    let response = crate::contract::execute(
        ...
        drop_staking_base::msg::provider_proposals::ExecuteMsg::UpdateConfig {
            new_config: drop_staking_base::state::provider_proposals::ConfigOptional {
                ...
                proposal_votes_address: Some(api.addr_make("proposal_votes_1").to_string()),
                validators_set_address: Some(api.addr_make("validators_set_1").to_string()),
    ...
    assert_eq!(
        ...
        to_json_binary(&drop_staking_base::state::provider_proposals::Config {
            ...
            proposal_votes_address: Some(api.addr_make("proposal_votes_1").to_string()),
            validators_set_address: api.addr_make("validators_set_1").to_string(),
            init_proposal: 1,
