...
NEUTRON_SIDE_PORT_ID="${NEUTRON_SIDE_PORT_ID:?Variable should be explicitly specified}"
ICQ_UPDATE_PERIOD="${ICQ_UPDATE_PERIOD:?Variable should be explicitly specified}"
SALT="${SALT:?Variable should be explicitly specified}"
SUBDENOM="${SUBDENOM:?Variable should be explicitly specified}"
TOKEN_METADATA_DESCRIPTION="${TOKEN_METADATA_DESCRIPTION:?Variable should be explicitly specified}"
TOKEN_METADATA_DISPLAY="${TOKEN_METADATA_DISPLAY:?Variable should be explicitly specified}"
TOKEN_METADATA_EXPONENT="${TOKEN_METADATA_EXPONENT:?Variable should be explicitly specified}"
TOKEN_METADATA_NAME="${TOKEN_METADATA_NAME:?Variable should be explicitly specified}"
TOKEN_METADATA_SYMBOL="${TOKEN_METADATA_SYMBOL:?Variable should be explicitly specified}"
CORE_PARAMS_IDLE_MIN_INTERVAL="${CORE_PARAMS_IDLE_MIN_INTERVAL:?Variable should be explicitly specified}"
CORE_PARAMS_LSM_REDEEM_THRESHOLD="${CORE_PARAMS_LSM_REDEEM_THRESHOLD:?Variable should be explicitly specified}"
CORE_PARAMS_LSM_MIN_BOND_AMOUNT="${CORE_PARAMS_LSM_MIN_BOND_AMOUNT:?Variable should be explicitly specified}"
CORE_PARAMS_LSM_REDEEM_MAX_INTERVAL="${CORE_PARAMS_LSM_REDEEM_MAX_INTERVAL:?Variable should be explicitly specified}"
CORE_PARAMS_BOND_LIMIT="${CORE_PARAMS_BOND_LIMIT:?Variable should be explicitly specified}"
CORE_PARAMS_MIN_STAKE_AMOUNT="${CORE_PARAMS_MIN_STAKE_AMOUNT:?Variable should be explicitly specified}"
CORE_PARAMS_ICQ_UPDATE_DELAY="${CORE_PARAMS_ICQ_UPDATE_DELAY:?Variable should be explicitly specified}"
STAKER_PARAMS_MIN_STAKE_AMOUNT="${STAKER_PARAMS_MIN_STAKE_AMOUNT:?Variable should be explicitly specified}"
STAKER_PARAMS_MIN_IBC_TRANSFER="${STAKER_PARAMS_MIN_IBC_TRANSFER:?Variable should be explicitly specified}"
TIMEOUT_LOCAL="${TIMEOUT_LOCAL:?Variable should be explicitly specified}"
TIMEOUT_REMOTE="${TIMEOUT_REMOTE:?Variable should be explicitly specified}"
