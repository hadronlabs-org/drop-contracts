...
export type ArrayOfTupleOf_StringAnd_TupleOf_StringAnd_Uint128 = [
  string,
  [string, Uint128],
][];
...
export type ArrayOfTupleOf_StringAnd_TupleOf_StringAnd_Uint1281 = [
  string,
  [string, Uint128],
][];
/**
...
export class Client {
  ...
  queryPendingLSMShares =
    async (): Promise<ArrayOfTupleOf_StringAnd_Tuple_of_String_and_Uint128> => {
      return this.client.queryContractSmart(this.contractAddress, {
