...
import { LidoInterchainInterceptorAuthz } from '../generated/contractLib';
import {
  QueryClient,
  StakingExtension,
  setupAuthzExtension,
...
import {
  ...
  Transaction,
  Transfer,
} from '../generated/contractLib/lidoInterchainInterceptorAuthz';
...
describe('Interchain interceptor with AuthZ support', () => {
  const context: {
    park?: Cosmopark;
  ...
  it('instantiate', async () => {
    ...
    const instantiateRes =
      await LidoInterchainInterceptorAuthz.Client.instantiate(
        client,
        account.address,
        res.codeId,
        {
    ...
    context.contractClient = new LidoInterchainInterceptorAuthz.Client(
      client,
